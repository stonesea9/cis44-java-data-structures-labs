Lab Project 2: Recursive Search and Binary Search Trees
Objective:
This lab explores recursive approaches to searching. You will implement the Recursive Binary Search algorithm and the search algorithm for a Binary Search Tree (BST), which is naturally recursive.

Template Code (RecursiveSearch.java)
